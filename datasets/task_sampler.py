...
class SamplerFactory:
    ...
    def get_sampler(dataset, tasks, trainset, testset=None, capacity=None):
        ...
        elif "mini_imagenet" in dataset:
            return MiniImagenetSampler(tasks, trainset, testset)
...
class MiniImagenetSampler:
    ...
    def __init__(self, tasks, trainset, testset):
        self.tasks = tasks
        self.task_sampler = SampleMiniImagenet(trainset, testset)
        self.task_sampler.add_complete_iteraetor(self.tasks)
